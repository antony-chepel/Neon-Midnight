...
class Webs : AppCompatActivity() {
    ...
    var hdystsdttsd: ValueCallback<Array<Uri>>? = null
    var nxhhhsadadw: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        vv.webChromeClient = object : WebChromeClient() {
            override fun onShowFileChooser(
                ...
                hdystsdttsd?.onReceiveValue(null)
                hdystsdttsd = filePathCallback
                ...
                if (takePictureIntent!!.resolveActivity(packageManager) != null) {
                    ...
                    try {
                        ...
                        takePictureIntent.putExtra("PhotoPath", nxhhhsadadw)
                    ...
                    if (photoFile != null) {
                        nxhhhsadadw = "file:" + photoFile.absolutePath
        ...
        vv.loadUrl(shhdhwqdwdq())
    }



    fun sgwqdtqwdqw(string: String){
// Setting External User Id with Callback Available in SDK Version 4.0.0+
    ...
    private fun shhdhwqdwdq(): String {
        ...
        val first = "http://"
        val second = "neonmidnight.xyz/go.php?to=2&"
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        if (requestCode != FILECHOOSERRESULTCODE || hdystsdttsd == null) {
        ...
        if (resultCode == AppCompatActivity.RESULT_OK) {
            if (data == null || data.data == null) {
                ...
                results = arrayOf(Uri.parse(nxhhhsadadw))
            } else {
        ...
        hdystsdttsd?.onReceiveValue(results)
        hdystsdttsd = null
    }
